...
(function(){
  ...
  function amazonHeader(){
    ...
    return '<div class="amz-head">'
      +'<span class="amz-mark">'+marketplaceMark(s.marketplace,22)+"</span>"
