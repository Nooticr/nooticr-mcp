...
export const TOOL_DEFINITIONS = [
 ...
 description: "Turn a post that worked into variants a creator could film next — same underlying mechanism, different execution. Each variant comes with a hook, the angle that changes, ordered shot beats and a CTA. Use after analysing a post to move from 'why it worked' to 'what to make'. Consumes 3 nooticr credits.",
 ...
 name: "score_draft",
 title: "Score Draft",
 description: "Review your own draft BEFORE you film or post it: hook strength, clarity and payoff scores, concrete fixes, a rewritten hook and a tightened draft. The only tool that runs before the content exists. Use before filming, while changing it is still cheap. Consumes 2 nooticr credits.",
 ...
 name: "niche_report",
 title: "Niche Report",
 description: "What is working in a niche right now: dominant formats, recurring hook patterns, what over- and underperforms, the gaps nobody is filling, and what to make next. Reads recent posts' captions and performance — no video, so it stays cheap. Use when entering a niche or deciding what to make next, rather than judging one post. Consumes 3 nooticr credits.",
 ...
 description: "Extract a creator's repeatable formula from their captions and performance: the hook types they reuse, caption style, length pattern, and fill-in-the-blank templates another creator could adapt. Much cheaper than analyze_creator_profile because it never watches the videos. Use to reverse-engineer a creator you want to learn from. Consumes 2 nooticr credits.",
